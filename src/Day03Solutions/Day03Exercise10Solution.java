...
public class Day03Exercise10Solution {

    public static int hexaDigit2Decimal(char hexaDigit) {
        switch (hexaDigit) {
            case '0':
                return 0; // no break; needed if we return
            case '1':
                return 1;
            case '2':
                return 2;
    ...
    public static char decimal2hexaDigit(int decimal) {
        switch (decimal) {
            case 0:
                return '0';
            case 1:
    ...
    public static String hexadecimal2decimal(String hexadecimal) {
    ...
    public static String decimal2hexadecimal(String decimal) {
        ...
        while (decimalInt > 0) {
            ...
            char hexDigit = decimal2hexaDigit(decimalInt % 16);
    ...
    public static void main(String[] args) {
        ...
        if (hexadecimalInput) {
            String decimal = hexadecimal2decimal(input);
            System.out.println("The decimal value is: " + decimal);
        } else {
            String hexadecimal = decimal2hexadecimal(input);
