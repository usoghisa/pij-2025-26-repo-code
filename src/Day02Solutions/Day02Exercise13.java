...
public class Day02Exercise13 {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < afterTheDot.length(); i++) {
        ...
        int after;
        if (numberOfLeadingZerosAfterDot == afterTheDot.length()) {
            after = 0; // if nothing follows the zeros, it's zero
        } else {
            after = Integer.parseInt(afterTheDot); // works also with leading zeros
        }
        ...
        if (numberOfLeadingZerosAfterDot > 0) {
            if (addZeroPointFiveToResult) {
                toPrint = toPrint + "5";
            } else {
                toPrint = toPrint + "0";
            }
            // Note the initial value of i!
            for (int i = 1; i < numberOfLeadingZerosAfterDot; i++) {
                toPrint = toPrint + "0";
            }
            ...
            // Alternative 1:
            if (firstDigitOfAfterHalf == '0') {
                digitToPrint = '5';
            } else if (firstDigitOfAfterHalf == '1') {
                digitToPrint = '6';
            } else if (firstDigitOfAfterHalf == '2') {
                digitToPrint = '7';
            } else if (firstDigitOfAfterHalf == '3') {
                digitToPrint = '8';
            } else if (firstDigitOfAfterHalf == '4') {
                digitToPrint = '9';
            } else {
